...
# ╔═╡ ff40a1a2-7547-4291-9ce6-c87be3eb7c74
md"""
# 2. Solving for accelerations and velocities:
"""
...
# ╔═╡ 08c36414-f212-4e48-9c0d-09199cd078fa
md"""
# 3. Animating the system:
"""
...
begin
    ...
    animationengine = @animate for crank_angle in range(0, 2π; length=120)
        ...
        plot(xlim=plot_limits, ylim=plot_limits, aspect_ratio=:equal, legend=false, axis=false, dpi = 300, title="Radial Engine Mechanism")
		# shafts 
        for axis_unit in cylinder_directions
            plot!([0, cylinder_length*axis_unit[1]], [0, cylinder_length*axis_unit[2]], lw=10, c=:gray, alpha = 0.75)
        end
		# rigid bars
        for piston_point in piston_points
            plot!([crank_pin[1], piston_point[1]], [crank_pin[2], piston_point[2]], lw=3, c=:gold)
			# pistons  
            scatter!([piston_point[1]], [piston_point[2]], ms=8, c=:steelblue)
        end
		# rigid bars' intersection
		scatter!([crank_pin[1]], [crank_pin[2]], ms=7, c=:red, alpha = 0.5)
    end
